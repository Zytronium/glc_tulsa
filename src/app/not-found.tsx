...
export default function NotFound() {
    return (
        <main className="min-h-screen flex flex-col items-center justify-center px-6 py-20 bg-stone-100 text-ink">
            ...
            {/* -------- 404 label -------- */}
            <p
                className="font-meta text-xs tracking-[0.25em] uppercase text-stone-500 mb-2"
            >
                Error
            </p>
            <h1
                className="font-heading text-[8rem] leading-none text-garnet-600 select-none mb-6"
            >
                404
            </h1>

            {/* -------- stained glass window image -------- */}
            <div className="relative w-92.25 h-144.25 mb-10">
                <Image
            ...
            {/* -------- heading -------- */}
            <h2
                className="font-display text-2xl text-vestment-700 text-center mb-3 max-w-sm"
            >
            ...
            <Link
                href="/"
                className="
          font-meta text-xs tracking-[0.2em] uppercase
          text-vestment-600 border border-vestment-600
          px-6 py-3
          hover:bg-vestment-700 hover:text-stone-50 hover:border-vestment-700
