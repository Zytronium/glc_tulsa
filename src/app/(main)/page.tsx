...
import type { HomePageQuery, EventConnectionQuery, LayoutQuery } from "../../../tina/__generated__/types";
...
export default async function Home() {
  const [homeData, layoutData, eventsData] = await Promise.all([
  ...
  return <ClientPage homeQuery={homeData} layoutQuery={layoutData} events={events} />;
}
